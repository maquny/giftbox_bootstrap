                    ...
                    <template v-slot:default="{ hide }">
                        <div class="px-3 py-3">
                            ...
                            <div class="m_menu_cont px-3 py-2">
                                <div class="m_menu_a">
                                    <router-link to="/Hello">상품권 판매요청</router-link>
                                    <template >
                                        <div class="t_menu" @click="activeMenu1 = true, activeMenu2 = false" :class="{ active: activeMenu1 }">
                                            ...
                                            <div class="t_menu_body">
                                                <router-link to="/Hello">판매거래내역</router-link>
                                                <router-link to="/Hello">계좌인증 관리</router-link>
                                                <router-link to="/Hello">개인정보 관리</router-link>
                                                <router-link to="/Hello">판매한도 확인</router-link>
                                            </div>
                                        </div>
                                    </template>
                                    ...
                                    <template>
                                        <div class="t_menu" @click="activeMenu2 = true, activeMenu1 = false" :class="{ active: activeMenu2 }">
                                            ...
                                            <div class="t_menu_body">
                                                <router-link to="/Hello">공지사항</router-link>
                                                <router-link to="/Hello">FAQ</router-link>
                                                <router-link to="/Hello">1:1문의/답변</router-link>
                                            </div>
                                        </div>
                                    </template>
                ...
                <div class="menu">
                    <ul>
                        ...
                        <li @mouseover="listTwo = true" @mouseleave="listTwo = false">
                            <router-link to="/Hello">고객센터</router-link>
                            <transition name="fade">
                                <ul v-if="listTwo" @click="listTwo = false">
                                    <li><router-link to="/Hello">공지사항</router-link></li>
                                    <li><router-link to="/Hello">FAQ</router-link></li>
                                    <li><router-link to="/Hello">1:1 문의/답변</router-link></li>
                                </ul>
                            </transition>
                        </li>
                    </ul>
